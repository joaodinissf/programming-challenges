...
vector<int32_t> inline matrix_int_2_vec(const int32_t &matrix) {
  // Input: 012345678
  // Output: [0,1,2,3,4,5,6,7,8]

  vector<int32_t> vec(9);
  int32_t temp_matrix = matrix;
  for (int32_t i = 0; i < 9; i++) {
    vec[i] = temp_matrix % 10;
    temp_matrix /= 10;
  }
  return vec;
}

int32_t inline game_state_vector_to_int(const vector<int32_t> &matrix) {
...
vector<int32_t> rotate_matrix_90_clockwise(const vector<int32_t> &matrix) {
...
vector<int32_t> rotate_matrix_180(const vector<int32_t> &matrix) {
  // Input: [0,1,2,3,4,5,6,7,8] represents:
  // 0 1 2
  // 3 4 5
  // 6 7 8
...
vector<int32_t> rotate_matrix_270_clockwise(const vector<int32_t> &matrix) {
  // Input: [0,1,2,3,4,5,6,7,8] represents:
  // 0 1 2
  // 3 4 5
  // 6 7 8
...
vector<int32_t> reflect_matrix_horizontal(const vector<int32_t> &matrix) {
  // Input: [0,1,2,3,4,5,6,7,8] represents:
  // 0 1 2
  // 3 4 5
  // 6 7 8
...
vector<int32_t> reflect_matrix_vertical(const vector<int32_t> &matrix) {
  // Input: [0,1,2,3,4,5,6,7,8] represents:
  // 0 1 2
  // 3 4 5
  // 6 7 8
...
vector<int32_t> reflect_matrix_diagonal(const vector<int32_t> &matrix) {
  // Input: [0,1,2,3,4,5,6,7,8] represents:
  // 0 1 2
  // 3 4 5
  // 6 7 8
...
vector<int32_t> reflect_matrix_counterdiagonal(const vector<int32_t> &matrix) {
  // Input: [0,1,2,3,4,5,6,7,8] represents:
  // 0 1 2
  // 3 4 5
  // 6 7 8
...
vector<int32_t> get_matrix_canonical_form(const vector<int32_t> &matrix) {
  // Apply all 8 possible transformations and find the one with lowest
  // lexicographical rank

  vector<vector<int32_t>> all_forms = {
      matrix,                                // Identity
  ...
  // comparison
  vector<int64_t> form_values;
  form_values.reserve(all_forms.size());

  // TODO Replace with matrix_vec_2_int
  for (const auto &form : all_forms) {
    int32_t value = game_state_vector_to_int(form);
    form_values.push_back(value);
  }

  // Find the index of the minimum value
  auto min_it = min_element(form_values.begin(), form_values.end());
  return all_forms[distance(form_values.begin(), min_it)];
}
